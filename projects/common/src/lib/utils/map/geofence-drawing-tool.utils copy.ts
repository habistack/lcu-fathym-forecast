...
export class GeofenceDrawingTool {

//     /**
//      * The layer the geofence will be above, not required
//      */
...
//     /**
//      * Bubble layer to hold the geofence shape
//      */
...
//     /**
//      * A tool for drawing geofences on the map using a mouse.
//      *
//      * @param map An Azure Map's map instance to attach the drawing tool too.
//      *
...
//     /**
//      * Start setting up the geofence layer
//      */
//     protected setupGeofence(): void {
...
//         if (activeShape) {
//             // update the last coordinate in the geofence which is there for preview purposes
//             const ring: Array<any> = activeShape.getCoordinates()[0];
...
//                     // close the ring
//                     if (ring.length >= 1) {
//                         ring.push([ring[0][0], ring[0][1]]); // Add the first coordinate to the end to close the geofence.
//                     }
...
//      *
//      * @param firstPos first geofence position
//      *
//      * @param last last geofence position
//      */
...
//             console.log('pixelDistance', c / groundResolution);
