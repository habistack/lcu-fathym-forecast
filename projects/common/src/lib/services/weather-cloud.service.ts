...
import { WeatherCloudSearchConstants } from '../utils/constants/wc-search.constants';
...
export class WeatherCloudService {
   ...
   */
  public HandleRoute(search: WeatherCloudSearchModel): Observable<object> {
  ...
  public LoadDataSources() {
    ...
    return [
      {
        Name: WeatherCloudSearchConstants.FORECAST_MODEL_HRRR,
        URLPrefix: '/fcst',
        FcstCfg: 'hrrr_config',
      ...
      {
        Name: WeatherCloudSearchConstants.FORECAST_MODEL_GFS,
        URLPrefix: '/fcst',
        FcstCfg: 'gfs_config',
        Host: 'http://fathymwx.westus.cloudapp.azure.com',
        VarNames: ''
      ...
      {
        Name: WeatherCloudSearchConstants.FORECAST_MODEL_BLEND,
        URLPrefix: '/blend',
        FcstCfg: null,
        Host: 'http://fathymwx.westus.cloudapp.azure.com',
        VarNames: ''
      ...
      {
        Name: WeatherCloudSearchConstants.FORECAST_MODEL_MWAVE,
        URLPrefix: '/fcst',
   ...
   */
  public ShapeRegion(points: Array<Array<number>>, searchData: WeatherCloudSearchModel): any {
